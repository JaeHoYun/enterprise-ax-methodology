...
DX를 흉내 낸 어설픈 AX는 효과 없이 예산만 태웁니다. 이 가이드는 그 실패의 구조를 **진단**하고, 빅뱅 전사 전환 대신 **증거 기반 점진적 AX**라는 대안을 제시하며, 그 대안을 **Private AI(사내 AI)로 실제로 갖추는 전략**까지를 다루는 공개 실무 가이드입니다.
...
| 10 | [AI 거버넌스 — 영역별 통제 맵과 규제 연계](docs/10-governance.md) | 모델, 데이터, 인프라, 보안, 에이전트 영역별 통제, 에이전트 거버넌스(자율성, 신원, 레지스트리), 섀도 AI의 발견과 양성화, 법정 의무와 표준 연계 |
...
| 워크시트 | [채워넣기 워크시트](worksheet/README.md) | 성숙도, 캔버스, 투자 케이스, 파일럿 게이트, 확장 준비도 + 브라운필드 진단(인벤토리, 갭, 처분, FinOps 스코어카드, 거버넌스와 주권 갭, 보고서, 차터) |
...
- **"직원들이 개인 AI 도구를 몰래 쓰고 있다면"** → [10 10.4절](docs/10-governance.md) + [거버넌스와 주권 갭 워크시트 A절](worksheet/governance-sovereignty-gap.md)
