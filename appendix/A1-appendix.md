...
- **v1.5 (2026-06):** 출처 정합성 정정 — §4.2 과업 분해 3분류에 붙어 있던 'PAAM'(Purpose–Automation·Augmentation·Manual) 머리글자 라벨을 본문·용어집·참고에서 제거하고 일반 개념 서술로 환원. 목적 우선 분해와 자동화/증강/수동 분류는 널리 통용되는 개념이나, 'PAAM'은 확립된 표준 용어가 아니어서 특정 조어로 귀속될 소지를 없앰.
