...
전제하지 않습니다. 사내 구축을 선택한 경우의 구현 경로 한 예를 00장, [06장](../docs/06-execution-environment.md) 끝, 08장 끝, [README](../README.md)의 관련 가이드에서 안내할 뿐입니다.

## A1.2 참고

- 본문의 검증 방식(결정의 되돌림 가능성 구분, 최소 관통 파일럿, 가치 가설과 게이트)은 제품 개발, 린 방법론, 전환 관리 분야에서 널리 통용되는 사고를 AX 맥락에 맞춰 정리한 것입니다. 되돌림 가능성의 구분은 Amazon이 의사결정을 두 유형으로 나눌 때 쓴 two-way door 비유에서 왔습니다.
